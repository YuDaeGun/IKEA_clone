...
function convert(dto) {
    ...
    sect3_teaser_img.innerHTML += `<a href="${cpath}/product/view/${dto.product_idx}"><img id="hover_img" class="sect3_banner2" src="${cpath}/IKEA_productImage/${dto.image_filename2}"></a>`
    ...
    sect3_teaser_content.innerHTML += `<div class="sect3_product_name"><h3>${dto.product_name}</h3></div>
        ...
        <div class="sect3_product_price"><span>￦</span>${dto.product_price}</div>
